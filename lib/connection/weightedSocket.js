...
/**
 * WeightedSocket is a ReactiveSocket which compute an estimation of the load
 * (or weight) of the remote server.
 *
 * This load is used by the loadbalancer to decide how to shape traffic.
 *
 * @param {ReactiveSocket} reactivesocket The underlying ReactiveSocket
 * @param {Object} opts Options object
 * @param {Object} opts.inactivityPeriodMs period in ms, after which the
 *      algorithm will start decaying the value.
 * @param {Number} opts.medianBufferSize Number of elements to keep in the
 *      buffer when estimating the median
 *
 * This function override the function from the underlying ReactiveSocket.
 *
 * @returns {WeightedSocket}
 */
