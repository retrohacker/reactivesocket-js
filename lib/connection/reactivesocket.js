...
ReactiveSocket.prototype._sendKeepalive = function _sendKeepalive(requireResponse) {
    var self = this;
...
ReactiveSocket.prototype._getNewStream = function _getNewStream(timeoutMs) {
    var self = this;
...
ReactiveSocket.prototype._deleteStream = function _deleteStream(id, noError) {
    var self = this;
