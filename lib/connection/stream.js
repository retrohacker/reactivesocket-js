 ...
 * @param {Object} opts.recorder The metrix recorder.
 * @constructor
 *
...
function RSStream(opts) {
    ...
    var recorder = (opts.recorder || DISABLE_RECORDER).scope('stream');
    this._metrics = {
        responses: recorder.counter('responses'),
        requests: recorder.counter('responses'),
        connectionError: recorder.counter('connectionError'),
        applicationError: recorder.counter('applicationError'),
        rejected: recorder.counter('rejected'),
        cancelled: recorder.counter('cancelled'),
        invalid: recorder.counter('invalid'),
        error: recorder.counter('error')
    };
